...
public class PersonControllerXmlTest extends AbstractIntegrationTest {
	...
	public void testFindAll() throws JsonMappingException, JsonProcessingException {
		...
		assertEquals(390, foundPersonOne.getId());

		assertEquals("Amargo", foundPersonOne.getFirstName());
		assertEquals("Smallpeace", foundPersonOne.getLastName());
		assertEquals("28760 Arkansas Alley", foundPersonOne.getAddress());
		...
		assertEquals(854, foundPersonSix.getId());

		assertEquals("Ancell", foundPersonSix.getFirstName());
		assertEquals("Joskovitch", foundPersonSix.getLastName());
		assertEquals("1 Scofield Alley", foundPersonSix.getAddress());
	...
	public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
		...
		assertTrue(content.contains("<links><rel>self</rel><href>http://localhost:8888/api/person/v1/1006</href></links>"));
		assertTrue(content.contains("<links><rel>self</rel><href>http://localhost:8888/api/person/v1/390</href></links>"));
		assertTrue(content.contains("<links><rel>self</rel><href>http://localhost:8888/api/person/v1/973</href></links>"));
